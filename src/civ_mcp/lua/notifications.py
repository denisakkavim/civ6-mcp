...
NOTIFICATION_TOOL_MAP: dict[str, str] = {
    ...
    "NOTIFICATION_CHOOSE_CITY_PRODUCTION": "set_city_production(city_id=..., item_type=...)",
    ...
    "NOTIFICATION_CHOOSE_PANTHEON": "get_belief_options() then choose_pantheon(belief_type=...)",
    "NOTIFICATION_CHOOSE_RELIGION": "get_belief_options() then found_religion(religion_type=..., follower_belief_type=..., founder_belief_type=...)",
    "NOTIFICATION_CHOOSE_BELIEF": "get_belief_options() then found_religion(religion_type=..., follower_belief_type=..., founder_belief_type=...)",
    ...
    "NOTIFICATION_CLAIM_GREAT_PERSON": "get_great_people() then great_person_action(individual_id=..., action='recruit'|'patronize'|'reject')",
    ...
    "NOTIFICATION_WORLD_CONGRESS_BLOCKING": "get_world_congress() then queue_world_congress_votes()",
    "NOTIFICATION_WORLD_CONGRESS_RESULTS": "get_world_congress() (review results)",
    "NOTIFICATION_WORLD_CONGRESS_SPECIAL_SESSION_BLOCKING": "get_world_congress() then queue_world_congress_votes()",
...
BLOCKING_TOOL_MAP: dict[str, str] = {
    ...
    "ENDTURN_BLOCKING_PANTHEON": "Use get_belief_options() then choose_pantheon(belief_type=...)",
    ...
    "ENDTURN_BLOCKING_WORLD_CONGRESS_SESSION": "MUST VOTE: Use get_world_congress() to see resolutions, then queue_world_congress_votes() to register all votes, then end_turn(). Deploy ALL diplomatic favor!",
    ...
    "ENDTURN_BLOCKING_CONSIDER_RAZE_CITY": "Use resolve_city_capture(action='keep') or 'raze'/'liberate_founder'/'liberate_previous'",
    "ENDTURN_BLOCKING_CONSIDER_DISLOYAL_CITY": "Use resolve_city_capture(action='keep') or 'reject'",
